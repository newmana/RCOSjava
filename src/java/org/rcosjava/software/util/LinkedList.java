...
/**
 * A simple implementation of a linked list. <P>
 *
 *
 *
 * @author Brett Carter.
...
public class LinkedList
{
   ...
   *
   * @param theData The feature to be added to the After attribute
   */
   ...
   *
   * @param theData The feature to be added to the Before attribute
   */
   ...
   * @returm removes the current item from the list. If no curent item is
   *      selected, -1 is returnd. Otherwise, 0 is returned.
   */
  public int remove()
  {
    if (current == null)

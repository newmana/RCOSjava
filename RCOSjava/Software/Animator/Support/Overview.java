...
public class Overview extends Frame implements Runnable
{
  ...
  */
  ...
  {
    if (evt.target instanceof Image)
    {
      String whichObject = (String) evt.arg.toString();

      if (whichObject == "Close")
      {
        this.setVisible(false);
      }
      return true;
    }
    else if (evt.id == evt.WINDOW_DESTROY)
    {
      this.setVisible(false);
      return true;
    }
